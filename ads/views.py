...
class Search(ListView):
    ...
    def get_queryset(self):
        ...
        # return (Ad.objects.annotate(search=search_vector, rank=SearchRank(search_vector,search_query)).filter(search=search_query).order_by("-rank"))
        return Ad.objects.filter(Q(title__icontains=query)|Q(content_upload__icontains=query)|Q(game__name__icontains=query))
